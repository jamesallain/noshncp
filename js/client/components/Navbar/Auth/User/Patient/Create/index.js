...
import PatientCreateMutation from 'mutations/PatientCreate';
...
export default createContainer(Create, {
  fragments: {
    node() {
      return Relay.QL`
        fragment on Patient {
          ${PatientCreateMutation.getFragment('node')}
        }
      `;
    },
    viewer() {
      return Relay.QL`
        fragment on Viewer {
          ${PatientCreateMutation.getFragment('viewer')}
        }
      `;
    }
  }
