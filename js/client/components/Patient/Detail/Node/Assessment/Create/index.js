...
import AssessmentCreateMutation from 'mutations/AssessmentCreate';
...
export default createContainer(Create, {
  fragments: {
    node() {
      return Relay.QL`
        fragment on Patient {
          ${AssessmentCreateMutation.getFragment('node')}
        }
      `;
    },
    viewer() {
      return Relay.QL`
        fragment on Viewer {
          ${AssessmentCreateMutation.getFragment('viewer')}
        }
      `;
    }
  }
